...
- Scope: initial independent public documentation repository for the Stirling PDF open-source project.
- Implemented: README, overview, getting started, concepts, API/CLI, examples, FAQ, AI context, source map, and `llms.txt`.
